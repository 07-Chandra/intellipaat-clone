        ...
        <div className="program">
            <div className="header">
                ...
                <p>
                    ...
                    Computing by IITM Pravartak will help you gain expertise in
                    DevOps, access management, DevSecOps, Terraform, and more.
                </p>
            </div>
            <div className="highlight">
                ...
                <div className="points">
                    ...
                    <div className="item">
                        <AiOutlineCheckCircle className="icon" />
                        <p>Designed for Working Professionals and Freshers</p>
                    </div>
                    <div className="item">
                        <AiOutlineCheckCircle className="icon" />
            ...
            <div className="about">
                <div className="header">
                    <p className="heading">
                        About <span>IITM Pravartak Digital Skills Academy</span>
                    </p>
                    <p className="para">
                        IITM Pravartak, a Technology Innovation Hub of IIRM is
                        funded by Department of Science and Technology, GOI
                        under its National Mission on Interdisciplinary
                ...
                <div className="achivement">
                    ...
                    <ul className="list">
                        <li className="list-item">
                            ...
                            ‘Engineering’ Categories in NIRF 2022 from last 4th
                            consecutive year.
                        </li>
                        <li className="list-item">
                            IIT Madras has been identified as an ‘Institution of
                            Eminence’ by the Government of India.
                        </li>
                        <li className="list-item">
                            Ranked No. 4 Indian Institute in QS World University
                            Ranking and Ranked #250 in the International QS
                            World rankings 2023.
                        </li>
                    </ul>
                </div>
                ...
                <div className="certificate">
                    ...
                    <p className="note">
                        ...
                        only and may be subject to change at the discretion of
                        the IITM Pravartak.
                    </p>
                </div>
            </div>
